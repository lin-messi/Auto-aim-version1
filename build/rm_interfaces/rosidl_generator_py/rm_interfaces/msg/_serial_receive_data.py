...
class SerialReceiveData(metaclass=Metaclass_SerialReceiveData):
    ...
    def __init__(self, **kwargs):
        ...
        self.cur_yaw = kwargs.get('cur_yaw', float())
        self.cur_pitch = kwargs.get('cur_pitch', float())
    ...
    def __eq__(self, other):
        ...
        if self.bullet_speed != other.bullet_speed:
            return False
        if self.cur_yaw != other.cur_yaw:
            return False
        if self.cur_pitch != other.cur_pitch:
            return False
    ...
    @builtins.property
    def cur_yaw(self):
        """Message field 'cur_yaw'."""
        return self._cur_yaw

    @cur_yaw.setter
    def cur_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cur_yaw' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'cur_yaw' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._cur_yaw = value

    @builtins.property
    def cur_pitch(self):
        """Message field 'cur_pitch'."""
        return self._cur_pitch

    @cur_pitch.setter
    def cur_pitch(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cur_pitch' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'cur_pitch' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._cur_pitch = value
