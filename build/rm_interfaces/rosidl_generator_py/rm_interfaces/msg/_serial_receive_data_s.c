...
bool rm_interfaces__msg__serial_receive_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // cur_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "cur_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cur_yaw = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // cur_pitch
    PyObject * field = PyObject_GetAttrString(_pymsg, "cur_pitch");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cur_pitch = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // color
...
{
  /* NOTE(esteve): Call constructor of SerialReceiveData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_interfaces.msg._serial_receive_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SerialReceiveData");
  ...
  {  // cur_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cur_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cur_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cur_pitch
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cur_pitch);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cur_pitch", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
