...
class Metaclass_SetMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rm_interfaces.srv import _set_mode
...
class SetMode(metaclass=Metaclass_SetMode):
    from rm_interfaces.srv._set_mode import SetMode_Request as Request
    from rm_interfaces.srv._set_mode import SetMode_Response as Response
