...
#include "rm_interfaces/msg/detail/target__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_interfaces::msg::Target & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: d_za
  cdr << ros_message.d_za;
  // Member: d_zc
  cdr << ros_message.d_zc;
  // Member: yaw_diff
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces::msg::Target & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: d_za
  {
    size_t item_size = sizeof(ros_message.d_za);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: d_zc
  {
    size_t item_size = sizeof(ros_message.d_zc);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: yaw_diff
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::msg::Target;
    is_plain =
      (
      offsetof(DataType, position_diff) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::Target *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::msg::Target *>(
    untyped_ros_message);
...
{
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Target__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, Target)() {
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Target__handle;
}
