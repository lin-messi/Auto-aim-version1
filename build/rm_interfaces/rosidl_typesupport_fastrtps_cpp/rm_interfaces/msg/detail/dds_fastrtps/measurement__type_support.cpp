...
#include "rm_interfaces/msg/detail/measurement__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_interfaces::msg::Measurement & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces::msg::Measurement & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::msg::Measurement;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::Measurement *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::msg::Measurement *>(
    untyped_ros_message);
...
{
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Measurement__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, Measurement)() {
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Measurement__handle;
}
