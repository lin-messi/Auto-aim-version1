...
#include "rm_interfaces/msg/detail/armors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_interfaces::msg::Armors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces::msg::Armors & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rm_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Armor(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::msg::Armors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::Armors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::msg::Armors *>(
    untyped_ros_message);
...
{
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Armors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, Armors)() {
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Armors__handle;
}
