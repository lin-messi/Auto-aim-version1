...
#include "rm_interfaces/srv/detail/set_mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::srv::SetMode_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_interfaces::srv::SetMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::srv::SetMode_Request *>(
    untyped_ros_message);
...
{
  return &rm_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rm_interfaces::srv::SetMode_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_interfaces::srv::SetMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rm_interfaces::srv::SetMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rm_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Response__handle;
}
...
{
  return &rm_interfaces::srv::typesupport_fastrtps_cpp::_SetMode__handle;
}
