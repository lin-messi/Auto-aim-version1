...
#include "rm_interfaces/msg/detail/armors__rosidl_typesupport_fastrtps_c.h"
...
#include "rm_interfaces/msg/detail/armor__functions.h"  // armors
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_rm_interfaces__msg__Armor(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_rm_interfaces__msg__Armor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interfaces, msg, Armor)();
...
using _Armors__ros_msg_type = rm_interfaces__msg__Armors;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: armors
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rm_interfaces, msg, Armor
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: armors
  {
    ...
    if (ros_message->armors.data) {
      rm_interfaces__msg__Armor__Sequence__fini(&ros_message->armors);
    }
    if (!rm_interfaces__msg__Armor__Sequence__init(&ros_message->armors, size)) {
...
size_t get_serialized_size_rm_interfaces__msg__Armors(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Armors__ros_msg_type * ros_message = static_cast<const _Armors__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rm_interfaces__msg__Armor(
...
static uint32_t _Armors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_interfaces__msg__Armors(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interfaces
size_t max_serialized_size_rm_interfaces__msg__Armors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: armors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rm_interfaces__msg__Armor(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces__msg__Armors;
    is_plain =
      (
...
static size_t _Armors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_interfaces__msg__Armors(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interfaces, msg, Armors)() {
