...
#include "rm_interfaces/msg/detail/armor__rosidl_typesupport_fastrtps_c.h"
...
using _Armor__ros_msg_type = rm_interfaces__msg__Armor;
...
static uint32_t _Armor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_interfaces__msg__Armor(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces__msg__Armor;
    is_plain =
      (
...
static size_t _Armor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_interfaces__msg__Armor(
