...
{
  new (message_memory) rm_interfaces::msg::GimbalCmd(_init);
}

void GimbalCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_interfaces::msg::GimbalCmd *>(message_memory);
  typed_message->~GimbalCmd();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GimbalCmd_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(rm_interfaces::msg::GimbalCmd, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::GimbalCmd, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::GimbalCmd, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::GimbalCmd, fire),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GimbalCmd_message_members = {
  ...
  4,  // number of fields
  sizeof(rm_interfaces::msg::GimbalCmd),
...
{
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::GimbalCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, msg, GimbalCmd)() {
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::GimbalCmd_message_type_support_handle;
}
