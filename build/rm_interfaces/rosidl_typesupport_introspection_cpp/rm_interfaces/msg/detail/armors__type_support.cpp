...
{
  new (message_memory) rm_interfaces::msg::Armors(_init);
}

void Armors_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_interfaces::msg::Armors *>(message_memory);
  typed_message->~Armors();
}

size_t size_function__Armors__armors(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rm_interfaces::msg::Armor> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rm_interfaces::msg::Armor> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rm_interfaces::msg::Armor> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const rm_interfaces::msg::Armor *>(
    get_const_function__Armors__armors(untyped_member, index));
  auto & value = *reinterpret_cast<rm_interfaces::msg::Armor *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<rm_interfaces::msg::Armor *>(
    get_function__Armors__armors(untyped_member, index));
  const auto & value = *reinterpret_cast<const rm_interfaces::msg::Armor *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Armors_message_member_array[2] = {
  {
    ...
    offsetof(rm_interfaces::msg::Armors, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rm_interfaces::msg::Armor>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::Armors, armors),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Armors_message_members = {
  ...
  "Armors",  // message name
  2,  // number of fields
  sizeof(rm_interfaces::msg::Armors),
...
get_message_type_support_handle<rm_interfaces::msg::Armors>()
{
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::Armors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, msg, Armors)() {
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::Armors_message_type_support_handle;
}
