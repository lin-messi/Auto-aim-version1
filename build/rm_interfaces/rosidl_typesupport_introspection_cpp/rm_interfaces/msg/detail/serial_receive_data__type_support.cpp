...
{
  new (message_memory) rm_interfaces::msg::SerialReceiveData(_init);
}

void SerialReceiveData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_interfaces::msg::SerialReceiveData *>(message_memory);
  typed_message->~SerialReceiveData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SerialReceiveData_message_member_array[6] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::SerialReceiveData, cur_yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::SerialReceiveData, cur_pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::SerialReceiveData, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::SerialReceiveData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, msg, SerialReceiveData)() {
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::SerialReceiveData_message_type_support_handle;
}
