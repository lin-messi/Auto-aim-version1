...
static rosidl_typesupport_introspection_c__MessageMember rm_interfaces__msg__GimbalCmd__rosidl_typesupport_introspection_c__GimbalCmd_message_member_array[4] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__GimbalCmd, fire),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
