...
#include <stddef.h>
#include "rm_interfaces/msg/detail/serial_receive_data__rosidl_typesupport_introspection_c.h"
...
void rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rm_interfaces__msg__SerialReceiveData__init(message_memory);
}

void rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_fini_function(void * message_memory)
{
  rm_interfaces__msg__SerialReceiveData__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_message_member_array[6] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__SerialReceiveData, cur_yaw),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__SerialReceiveData, cur_pitch),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__SerialReceiveData, color),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_message_members = {
  ...
  rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_init_function,  // function to initialize message memory (memory has to be allocated)
  rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_message_type_support_handle = {
  0,
  &rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interfaces, msg, SerialReceiveData)() {
  ...
  return &rm_interfaces__msg__SerialReceiveData__rosidl_typesupport_introspection_c__SerialReceiveData_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
